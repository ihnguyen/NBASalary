...
lm4 <- update(lm3,~. -log(ORB+20)-log(FT+20)-sqrt(X2PA+20)-sqrt(TOV+20)-sqrt(X2P+20)-log(X2P.+20));summary(lm4); performance::check_model(lm4)
lm4a <- step(lm4);summary(lm4a); performance::check_model(lm4a);
...
anova(lm4e,lm2) # its okay
anova(lm4f,lm2) # its okay
anova(lm4g,lm2) # its okay
anova(lm4h,lm2) # its okay
anova(lm4i, lm2) # its okay
